...
##################################||||Vienna game||||#############################################
vienna_game = Tree("Vienna game", "e2e4")
...
vienna_game_position = vienna_game.root.children["e2e4"].children["e7e5"].children["b1c3"].children["g8f6"]

################################||||Queens gambit||||###############################################
queens_gambit = Tree("Queens Gambit", "d2d4")
queens_gambit.root.children["d2d4"] = Node("d7d5")
queens_gambit.root.children["d2d4"].children["d7d5"] = Node("c2c4")
queens_gambit_position = queens_gambit.root.children["d2d4"].children["d7d5"]

################################||||Queens gambit accepted||||###############################################
queens_gambit_accepted_position = queens_gambit.root.children["d2d4"].children["d7d5"]
queens_gambit_accepted_position.children["c2c4"] = Node("d5c4")
